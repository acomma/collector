...
言归正传，今天我要问你的问题是，<font color="#fa8e24">谈谈 Java 反射机制，动态代理是基于什么原理？</font>
...
cglib 动态代理采取的是创建目标类的子类的方式，因为是子类化，我们可以达到近似使用被调用者本身的效果。在 Spring 编程中，框架通常会处理这种情况，当然我们也可以[显式指定](https://www.cliffmeyers.com/blog/spring-aop-cglib-or-jdk-dynamic-proxies/)。关于类似方案的实现细节，我就不再详细讨论了。
...
![](ba9a5b6228b188f5b9b15017e29a302b.png)
