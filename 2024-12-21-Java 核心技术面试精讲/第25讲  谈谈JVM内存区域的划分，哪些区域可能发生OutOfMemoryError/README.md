...
今天我要问你的问题是，<font color="#fa8e24">谈谈 JVM 内存区域的划分，哪些区域可能发生 OutOfMemoryError？</font>
...
* 我在[专栏第 4 讲](https://time.geekbang.org/column/article/6970)的引用机制分析中，已经提到了 JVM 会去尝试回收软引用指向的对象等。
...
* 直接内存不足，也会导致 OOM，这个已经[专栏第 11 讲](https://time.geekbang.org/column/article/8369)介绍过。
