...
今天我要问你的问题是，<font color="#fa8e24">JVM 优化 Java 代码时都做了什么？</font>

与以往我来给出典型回答的方式不同，今天我邀请了隔壁专栏[《深入拆解 Java 虚拟机》](https://time.geekbang.org/column/intro/108)的作者，同样是来自 Oracle 的郑雨迪博士，让他以 JVM 专家的身份去思考并回答这个问题。
...
![](12526a857a7685af0d7c2ee389c0ca9d.png)
...
![](5c095075dcda0f39f0e7395ab9636378.png)
...
* 输出更多编译的细节。
    ...
    具体格式可以参考 Ben Evans 提供的[JitWatch](https://github.com/AdoptOpenJDK/jitwatch/)工具和[分析指南](https://www.oracle.com/technical-resources/articles/java/architect-evans-pt1.html)。

    ![](07b00499b0ca857fc3ccd51f7046d946.png)
