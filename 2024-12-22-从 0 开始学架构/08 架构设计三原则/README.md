前面几期专栏，我跟你系统的聊了架构设计的主要目的是为了解决软件系统复杂度带来的问题，并分析了复杂度的来源。从今天开始，我会分两期讲讲<span style="color:#fa8e24">架构设计的 3 个原则</span>，以及架构设计原则的案例。
...
![](2dca583c9634ffcc224852adab208d9c.png)

3 个组件组成的系统：

![](3f4181e7166570077c3a4701129c5274.png)

4 个组件组成的系统：

![](e5716355fb4a84a464e14c2fc3289a8c.png)

5 个组件组成的系统：

![](a14cf5f4dba6fca660dea0aa56ce5486.png)
...
![](83a8089855470db9d2a4449bb032d8bc.png)

如果对比 Windows 8 的架构和 Windows 1.0 的架构，就会发现它们其实是两个不同的系统了！

Android 的发展历史：

![](671adc5fb5ed7c4fcf89b23ac5612cc4.png)
