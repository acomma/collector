...
接下来我将介绍<span style="color:#fa8e24">互联网架构模板的“网络层”</span>技术的几个关键架构设计点，部分内容专栏前面已经有深入阐述，今天作为概要的总结把它们归纳一下。
...
![](78bc9b6fba23f495db9b595a45693833.png)
...
有关多中心设计更详细的内容，你可以查看专栏第[28](https://time.geekbang.org/column/article/9787)、[29](https://time.geekbang.org/column/article/10199)、[30](https://time.geekbang.org/column/article/10204)期的内容。
