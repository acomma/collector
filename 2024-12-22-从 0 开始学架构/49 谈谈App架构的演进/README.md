...
复习完我们就可以进入今天的正题，我来<span style="color:#fa8e24">谈谈 App 架构的演进</span>，以及上面这些架构设计关键点是如何体现的。
