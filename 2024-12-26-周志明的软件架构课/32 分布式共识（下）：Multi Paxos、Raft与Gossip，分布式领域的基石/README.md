...
![](6a95e3b4e4754d22507f4c68d1dd39e3.jpg)
...
一种典型而且非常常见的最终一致的分布式系统，就是[DNS 系统](https://time.geekbang.org/column/article/324213)，在各节点缓存的 TTL 到期之前，都有可能与真实的域名翻译结果存在不一致。
